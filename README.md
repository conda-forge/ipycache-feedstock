About ipycache-feedstock
========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipycache-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=456&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipycache-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipycache` can be installed with `conda`:
...
```
mamba install ipycache
```

It is possible to list all of the versions of `ipycache` available on your platform with `conda`:
...
```
mamba search ipycache --channel conda-forge
```
...
mamba repoquery search ipycache --channel conda-forge

# List packages depending on `ipycache`:
mamba repoquery whoneeds ipycache --channel conda-forge

# List dependencies of `ipycache`:
mamba repoquery depends ipycache --channel conda-forge
```
